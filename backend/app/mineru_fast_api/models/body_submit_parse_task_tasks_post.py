...
T = TypeVar("T", bound="BodySubmitParseTaskTasksPost")


@_attrs_define
class BodySubmitParseTaskTasksPost:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        body_submit_parse_task_tasks_post = cls(
            files=files,
            lang_list=lang_list,
            backend=backend,
        ...
        body_submit_parse_task_tasks_post.additional_properties = d
        return body_submit_parse_task_tasks_post
